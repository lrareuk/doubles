...
- **Fix (choose one):**
  - **(a) Correct the wording** to match reality: *"You can delete your double and its associated game data from inside the app at any time; this happens immediately. To fully delete your account, including your sign-in email and purchase history, contact us at alex@lrare.co.uk and we will erase it."* OR
